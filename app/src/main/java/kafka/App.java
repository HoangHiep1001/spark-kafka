...
public class App {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		kafkaParams.put("bootstrap.servers", "10.5.36.64:9092");
		...
		Collection<String> topics = Arrays.asList("rt-adn-gdsp");
		...
		JavaPairDStream<String, String> mappedStream = stream.mapToPair(record -> new Tuple2<>(record.key(), record.value()));
		JavaPairDStream<String, Iterable<String>> group = mappedStream.groupByKey();
		group.print();
